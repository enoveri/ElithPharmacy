...
const Sidebar = ({
  ...
  return (
    ...
    >
      ...
      >
        ...
        {(!collapsed || isMobile) && (
          <div className="flex items-center ml-10 transition-all duration-300">
            ...
            <div className="ml-4">
              <h1 className="text-xl font-bold tracking-wide" style={titleStyles}>
                Elith Pharmacy
              </h1>
      ...
      {/* Navigation Section */}
      <nav className={`${collapsed && !isMobile ? "px-3 py-6" : "px-6 py-8"} transition-all duration-300 flex flex-col flex-[0_0_60%]`}>
          ...
          {navItems.map((item, index) => (
            <li key={index} className="flex-1">
              <Link
                ...
                style={{
                  color: isActive(item.path) ? "var(--color-sidebar-text-active)" : "var(--color-sidebar-text)",
              ...
              >
                ...
                {(!collapsed || isMobile) && (
                  <span className="ml-4 font-medium transition-all duration-200 text-lg" style={{ fontFamily: "var(--font-family-sans)" }}>
                    {item.label}
                  </span>
                )}
                ...
                {isActive(item.path) && (!collapsed || isMobile) && (
                  <div
                    ...
                    style={{ backgroundColor: "var(--color-sidebar-text-active)" }}
                  />
                )}
      ...
      >
        ...
        >
          ...
          {(!collapsed || isMobile) && (
            <span className="font-medium text-lg" style={{ fontFamily: "var(--font-family-sans)" }}>
              Logout
            </span>
          )}
        </button>
