...
function EditSale() {
    ...
    const loadData = async () => {
      try {
        ...
        setSaleData({
          ...
          saleDate: existingSale.saleDate ? existingSale.saleDate.split('T')[0] : new Date().toISOString().split('T')[0],
        });
  ...
  const handleSubmit = async (e) => {
    ...
    const invalidItems = saleData.items.filter(item => !item.productId || item.quantity <= 0);
    ...
    return (
      ...
      >
        <div className="loading-container">
          ...
          />
          <p style={{ marginTop: "16px", color: isMobile ? "white" : "#6b7280" }}>
            Loading sale data...
          </p>
        </div>
      </div>
          ...
          >
            ...
            <div className={isMobile ? "mobile-form-group" : ""}>
              ...
              <input
                ...
                onChange={(e) => setSaleData(prev => ({ ...prev, discount: parseFloat(e.target.value) || 0 }))}
                className={isMobile ? "mobile-form-input" : ""}
                style={isMobile ? {} : {
                  width: "100%",
                  padding: "10px 12px",
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <span style={{ color: isMobile ? "rgba(255, 255, 255, 0.8)" : "#6b7280" }}>Subtotal:</span>
                <span style={{ color: isMobile ? "white" : "#1f2937", fontWeight: "500" }}>
              ...
              {saleData.discount > 0 && (
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  <span style={{ color: isMobile ? "rgba(255, 255, 255, 0.8)" : "#6b7280" }}>
