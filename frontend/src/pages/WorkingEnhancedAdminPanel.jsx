  ...
  const fetchUsers = async () => {
    try {
      ...
      const stats = {
        ...
        recentSignIns: data?.filter(u => u.last_sign_in_at && 
      ...
      >
        {filteredUsers.length === 0 ? (
          ...
          >
            ...
            >
              Get started by creating your first user to manage your pharmacy team.
            </p>
            <button
              onClick={() => setShowCreateModal(true)}
              style={{
              ...
              <tbody>
                {filteredUsers.map((user, index) => (
                  ...
                  >
                      ...
                      <div>
                        <span
                          style={{
                            ...
                            fontWeight: "600",
                            borderRadius: "999px",
                            backgroundColor: user.role === 'admin' ? '#fef2f2' : 
                                          user.role === 'manager' ? '#eff6ff' :
                                          user.role === 'pharmacist' ? '#f0fdf4' : '#f9fafb',
                            color: user.role === 'admin' ? '#991b1b' : 
                                   user.role === 'manager' ? '#1e40af' :
                                   user.role === 'pharmacist' ? '#166534' : '#374151',
                          }}
                        >
                          {user.role}
                        </span>
                    ...
                    <td style={{ padding: "20px 24px", whiteSpace: "nowrap", fontSize: "14px", color: "#6b7280" }}>
